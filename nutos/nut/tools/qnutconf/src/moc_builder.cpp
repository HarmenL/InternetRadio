...
QT_MOC_LITERAL(4, 22, 8), // "exitCode"
QT_MOC_LITERAL(5, 31, 17), // "processNextTarget"
QT_MOC_LITERAL(6, 49, 5), // "error"
QT_MOC_LITERAL(7, 55, 22), // "QProcess::ProcessError"
QT_MOC_LITERAL(8, 78, 23), // "readyReadStandardOutput"
QT_MOC_LITERAL(9, 102, 22) // "readyReadStandardError"

    },
    "Builder\0message\0\0done\0exitCode\0"
    "processNextTarget\0error\0QProcess::ProcessError\0"
    "readyReadStandardOutput\0readyReadStandardError"
};
...
void Builder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->processNextTarget((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (Builder::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Builder::message)) {
                *result = 0;
            }
        }
        {
            typedef void (Builder::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Builder::done)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Builder::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Builder.data,
      qt_meta_data_Builder,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void Builder::message(const QString & _t1)
{
