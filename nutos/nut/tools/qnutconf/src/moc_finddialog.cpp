...
QT_MOC_LITERAL(4, 26, 11), // "nextClicked"
QT_MOC_LITERAL(5, 38, 13) // "cancelClicked"

    },
    "FindDialog\0findNext\0\0text\0nextClicked\0"
    "cancelClicked"
};
...
void FindDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FindDialog::*_t)(const QString & );
...
// SIGNAL 0
void FindDialog::findNext(const QString & _t1)
{
